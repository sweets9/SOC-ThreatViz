...
const CSV_HEADERS = [
    ...
    { id: 'destinationport', title: 'destinationport' },
    { id: 'destinationservice', title: 'destinationservice' },
            ...
            .on('data', (row) => {
                try {
                    ...
                    const threat = {
                        ...
                        destinationport: row.destinationport ? parseInt(row.destinationport, 10) : null,
                        destinationservice: row.destinationservice || null,
...
function applyThreatDefaults(threat) {
    return {
        ...
        destinationport: threat.destinationport !== undefined ? (typeof threat.destinationport === 'number' ? threat.destinationport : parseInt(threat.destinationport, 10)) : null,
        destinationservice: threat.destinationservice || null,
